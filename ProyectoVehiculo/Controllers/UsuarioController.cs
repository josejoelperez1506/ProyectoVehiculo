...
namespace ProyectoVehiculo.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idUsuario,nombre,carne,correo,contraseña,compararContraseña,idRol")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idUsuario,nombre,carne,correo,contraseña,compararContraseña,idRol")] Usuario usuario)
        {
            if (ModelState.IsValid)
            {
